...
window.catalog = [{
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/item-4.jpg', // replace with path to image extracted from catalog layout
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/item-2.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/arrivals-img-1.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/arrivals-img-4.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/arrivals-img-2.jpg',
    preview: ['img/product-big.jpg', 'img/product-sm-1.jpg', 'img/product-sm-2.jpg', 'img/product-sm-3.jpg']
}, {
    ...
    colors: [],
    sizes: [],
    thumbnail: 'img/arrivals-img-3.jpg',
    preview: ['full image path 1', 'full image path 2', 'full image path 3']
}, {
